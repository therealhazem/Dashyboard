        ...
        <div className="">
            <Breadcrumb>
                <BreadcrumbList>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                        <BreadcrumbPage>Hazem Elgindy</BreadcrumbPage>
                    </BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb>
            {/* CONTAINER */}
                        ...
                        <div className="flex gap-4 mt-4">
                            ...
                            <HoverCard>
                                <HoverCardTrigger>
                                    <Shield
                                        size={36}
                                        className="rounded-full bg-green-800/30 borderorder-green-800/50 p-2"
                                    />
                                </HoverCardTrigger>
                                <HoverCardContent>
                    ...
                    <div className="bg-primary-foreground p-4 rounded-lg">
                        ...
                        <div className="space-y-4 mt-4">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span>therealhazem</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="font-bold">Email:</span>
                                <span>therealhazemelgindy@gmail.com</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="font-bold">Phone:</span>
                                <span>+20 1147005858</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="font-bold">Location:</span>
                                <span>Qalyoubia, Egypt</span>
                            </div>
                            <div className="flex items-center gap-2">
                ...
                <div className="w-full xl:w-2/3 space-y-6">
                    ...
                    <div className="bg-primary-foreground p-4 rounded-lg space-y-2">
                        <div className="flex items-center gap-2">
                            ...
                            <h1 className="text-xl font-semibold">Hazem Elgindy</h1>
                        </div>
                        <p className="text-sm text-muted-foreground">
